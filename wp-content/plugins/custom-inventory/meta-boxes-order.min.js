...
jQuery( function ( $ ) {
	...
	var wc_meta_boxes_order_items = {
		...
		add_item: function() {
			...
			$("#appliesWholesale").click(function () {
				if ($(this).is(":checked")) {
					$(".price_wholesale_title").show();
					$(".price_wholesale_field").show();
				} else {
					$(".price_wholesale_title").hide();
					$(".price_wholesale_field").hide();
				}
			});
		...
		backbone: {
			...
			init: function( e, target ) {
				if ( 'wc-modal-add-products' === target ) {
					...
					$( this ).on( 'change', '.wc-product-search', function() {
						...
						$( document.body ).trigger( 'wc-enhanced-select-init' );
						if ($('#appliesWholesale').is(":checked")) {
							$(".price_wholesale_title").show();
							$(".price_wholesale_field").show();
						} else {
							$(".price_wholesale_title").hide();
			...
			add_items: function( add_items ) {
				...
				var data = {
					...
					security : woocommerce_admin_meta_boxes.order_item_nonce,
					data     : add_items,
					apply_wholesale: $('#appliesWholesale').prop("checked")
				};

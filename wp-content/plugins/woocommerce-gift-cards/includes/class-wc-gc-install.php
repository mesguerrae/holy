...
class WC_GC_Install {
	...
	public static function install() {
		...
		// Add a notice to inform that gift card have moved under Marketing menu when updating within WC 4.4+.
		if ( WC_GC_Core_Compatibility::is_wc_version_gte( '4.4' ) && version_compare( self::$current_version, '1.6.0', '<' ) && 'marketing' === wc_gc_get_parent_menu() ) {
			WC_GC_Admin_Notices::add_maintenance_notice( 'marketing_menu' );
		}

...
namespace SkyVerge\WooCommerce\PluginFramework\v5_10_2\Handlers;
...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_10_2\\Handlers\\Script_Handler' ) ) :
...
abstract class Script_Handler {
	...
	protected function get_js_handler_class_name() {
		...
		return sprintf( '%s_v5_10_2', $this->js_handler_base_class_name );
	}

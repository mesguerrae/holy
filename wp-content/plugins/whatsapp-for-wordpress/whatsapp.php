 ...
 *
 * @wordpress-plugin
 * Plugin Name:       WhatsApp Chat |  VestaThemes.com
...
function nta_whatsapp_action_links($links) {
    $links = array_merge(array(
        '<a href="' . esc_url(admin_url('/admin.php?page=floating-widget-whatsapp')) . '">' . __('Settings', 'nta_whatsapp') . '</a>'
            ), $links);
    return $links;
}
...
//require_once (NTA_WHATSAPP_PLUGIN_DIR.'includes/nta-whatsapp-widget.php');


$nta_whatsapp = new NTA_Whatsapp();

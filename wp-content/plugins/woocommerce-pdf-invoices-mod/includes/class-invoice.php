		...
		public function get_invoice_info() {
			...
			return apply_filters( 'wpi_invoice_information_meta', array(
				'invoice_number'  => array(
					'title' => __( '#', 'woocommerce-pdf-invoices' ),
					'value' => $this->get_formatted_number(),
				),
				'invoice_date'    => array(
					'title' => __( 'Fecha de pago:', 'woocommerce-pdf-invoices' ),
					'value' => $this->get_formatted_date(),
				),
				'order_date'      => array(
					'title' => __( 'Fecha de la orden:', 'woocommerce-pdf-invoices' ),
					'value' => $this->get_formatted_order_date(),
				),
				'order_number'    => array(
					'title' => __( 'Numero de orden:', 'woocommerce-pdf-invoices' ),
					'value' => $this->order->get_order_number(),
				),
				'payment_method'  => array(
					'title' => __( 'Metodo de pago:', 'woocommerce-pdf-invoices' ),
					'value' => $this->order->get_payment_method_title(),
				),
				'shipping_method' => array(
					'title' => __( 'Metodo de envio:', 'woocommerce-pdf-invoices' ),

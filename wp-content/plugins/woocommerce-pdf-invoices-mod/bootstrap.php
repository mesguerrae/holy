<?php
/**
 * Plugin Name:             WooCommerce PDF Invoices Modified
 * Description:             Automatically generate and attach customizable PDF Invoices to WooCommerce emails and connect with Dropbox, Google Drive, OneDrive or Egnyte modified.
 * Version:                 1.0
 * Author:                  Modified
 * License:                 GPL-2.0+
 * Text Domain:             woocommerce-pdf-invoices-modified
 * Domain Path:             /lang

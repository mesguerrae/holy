    ...
    var v = {
            ...
            init: function () {
                g(document.body).bind("update_checkout", this.update_checkout),
                    ...
                    g(document.body).hasClass("woocommerce-order-pay") &&
                        (this.$order_review.on("click", 'input[name="payment_method"]', this.payment_method_selected), this.$order_review.on("submit", this.submitOrder), this.$order_review.attr("novalidate", "novalidate")),
            ...
            validate_field: function (e) {
                var t = g(this),
                    ...
                    r = e.type;
                if (("input" === r && o.removeClass("woocommerce-invalid woocommerce-invalid-required-field woocommerce-invalid-email woocommerce-validated"), "validate" === r || "change" === r)) {
                    if (
                        (i &&
                            ("checkbox" !== t.attr("type") || t.is(":checked")
                                ? "" === t.val() && (o.removeClass("woocommerce-validated").addClass("woocommerce-invalid woocommerce-invalid-required-field"), (c = !1))
                                : (o.removeClass("woocommerce-validated").addClass("woocommerce-invalid woocommerce-invalid-required-field"), (c = !1))),
                        n)
                    )
                        if (t.val())
                            new RegExp(
                                /^([a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+(\.[a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)*|"((([ \t]*\r\n)?[ \t]+)?([\x01-\x08\x0b\x0c\x0e-\x1f\x7f\x21\x23-\x5b\x5d-\x7e\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|\\[\x01-\x09\x0b\x0c\x0d-\x7f\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))*(([ \t]*\r\n)?[ \t]+)?")@(([a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.)+([a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[0-9a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.?$/i
                            ).test(t.val()) || (o.removeClass("woocommerce-validated").addClass("woocommerce-invalid woocommerce-invalid-email"), (c = !1));
            ...
            update_checkout_action: function (e) {
                if ((v.xhr && v.xhr.abort(), 0 !== g("form.checkout").length)) {
                    e = void 0 !== e ? e : { update_shipping_method: !0 };
                    ...
                    h.length &&
                        ...
                        g("#ship-to-different-address").find("input").is(":checked") &&
                            ((a = g("#shipping_country").val()),
                    ...
                    g(".woocommerce-checkout-payment, .woocommerce-checkout-review-order-table").block({ message: null, overlayCSS: { background: "#fff", opacity: 0.6 } }),
                        (v.xhr = g.ajax({
                            type: "POST",
                                    ...
                                    if (
                                        ...
                                        g.isEmptyObject(o) ||
                                            g(".payment_box :input").each(function () {
                                                var e = g(this).attr("id");
                                                e &&
                                                    (-1 !== g.inArray(g(this).attr("type"), ["checkbox", "radio"])
                                                        ? g(this).prop("checked", o[e]).change()
                                                        : -1 !== g.inArray(g(this).attr("type"), ["select"])
                                                        ? g(this).val(o[e]).change()
                                                        : null !== g(this).val() && 0 === g(this).val().length && g(this).val(o[e]).change());
                                            }),
                                        e && "failure" === e.result)
                                    ) {
            ...
            blockOnSubmit: function (e) {
                1 !== e.data()["blockUI.isBlocked"] && e.block({ message: null, overlayCSS: { background: "#fff", opacity: 0.6 } });
            },
            ...
            submit: function () {
                ...
                return (
                    o.is(".processing") ||
                        (!1 !== o.triggerHandler("checkout_place_order") &&
                            !1 !== o.triggerHandler("checkout_place_order_" + v.get_payment_method()) &&
                                ...
                                dataFilter: function (e, t) {
                                    ...
                                    return (
                                        null === o
                                            ...
                                            : v.is_valid_json(o[0])
                                            ? (console.log("Fixed malformed JSON. Original:"), console.log(e), (e = o[0]))
                                            : console.log("Unable to fix malformed JSON"),
                                        e
                                    );
                                },
                            ...
                            g.ajax({
                                ...
                                success: function (e) {
                                    ...
                                    try {
                                        if( e.result == "success"){
                                            var url = new URL(e.redirect)
                                            if(typeof e.order_id  == 'undefined' ){
                                                var params = url.pathname.split('/');
                                                var order_id = params[params.length - 2];
                                            }else{
                                            ...
                                            g.ajax({
                                                ...
                                                data: {action: 'ga_event_purchase', 'order_id': order_id},
                                                dataType: "json",
                                                async: false,
                                                success: function (e) {
                                                    dataLayer.push(e);
                                        ...
                                        if ("success" !== e.result || !1 === o.triggerHandler("checkout_place_order_success")) throw "failure" === e.result ? "Result failure" : "Invalid response";
        ...
        e = {
            ...
            show_coupon_form: function () {
                return (
                    g(".checkout_coupon").slideToggle(400, function () {
            ...
            submit: function () {
                ...
                t.addClass("processing").block({ message: null, overlayCSS: { background: "#fff", opacity: 0.6 } });
                    ...
                    g.ajax({
                        ...
                        success: function (e) {
                            g(".woocommerce-error, .woocommerce-message").remove(),
                                ...
                                e && (t.before(e), t.slideUp(), g(document.body).trigger("applied_coupon_in_checkout", [o.coupon_code]), g(document.body).trigger("update_checkout", { update_shipping_method: !1 }));
                        },
                        dataType: "html",
                    }),
                    !1
            ...
            remove_coupon: function (e) {
                ...
                g.ajax({
                    ...
                    success: function (e) {
                        g(".woocommerce-error, .woocommerce-message").remove(),
                            t.removeClass("processing").unblock(),
                            e && (g("form.woocommerce-checkout").before(e), g(document.body).trigger("update_checkout", { update_shipping_method: !1 }), g("form.checkout_coupon").find('input[name="coupon_code"]').val(""));
                    },
                    error: function (e) {
        ...
        o = {
            ...
            toggle_terms: function () {
                if (g(".woocommerce-terms-and-conditions").length)
                    return (
                        g(".woocommerce-terms-and-conditions").slideToggle(function () {
                            var e = g(".woocommerce-terms-and-conditions-link");
                            g(".woocommerce-terms-and-conditions").is(":visible")
                                ? (e.addClass("woocommerce-terms-and-conditions-link--open"), e.removeClass("woocommerce-terms-and-conditions-link--closed"))
                                : (e.removeClass("woocommerce-terms-and-conditions-link--open"), e.addClass("woocommerce-terms-and-conditions-link--closed"));
                        }),
                        !1
                    );
            },

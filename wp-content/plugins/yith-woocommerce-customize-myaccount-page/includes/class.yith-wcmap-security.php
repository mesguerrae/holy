...
if ( ! class_exists( 'YITH_WCMAP_Security' ) ) {
	...
	class YITH_WCMAP_Security {
        ...
        public function add_recaptcha_form(){
            ?>
            <div class="g-recaptcha" data-sitekey="<?php echo $this->_recaptcha_public; ?>"></div>
            <?php
        }
        ...
        public function get_message( $context = 'created', $customer_id = 0 ) {
            ...
            if( $customer_id ) {
                ...
                $msg_part = sprintf( __( 'You have to confirm your account. Please, click on the link in the verification email.', 'yith-woocommerce-customize-myaccount-page' ), $resend_link );
            }

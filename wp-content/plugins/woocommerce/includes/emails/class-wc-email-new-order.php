...
if ( ! class_exists( 'WC_Email_New_Order' ) ) :
	...
	class WC_Email_New_Order extends WC_Email {
		...
		public function __construct() {
			...
			//MOD#1 Se agrego accion para envio de correo a administrador
		...
		public function trigger( $order_id, $order = false ) {
			...
			//MOD#2 Se agrego validacion para que al admin solo e lleguen los pedidos confirmados
			if ( $this->is_enabled() && $this->get_recipient() && $order->get_status() == 'processing') {

...
<p><?php esc_html_e('Need Marketing Insight? ,','contact-form-hubspot-crm')?> <a href="<?php echo $plugin_url ?>&section=vxc_premium"><?php esc_html_e('Go Pro!','contact-form-hubspot-crm')?></a></p>
</div>
 <?php
 }else{
